                ...
                <nav className="navbar navbar-expand-lg bg-dark navbar-dark">
                    ...
                    <div className="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div className="navbar-nav mr-auto">
                            ...
                            <a href="service.html" className="nav-item nav-link">Product</a>
                            <a href="team.html" className="nav-item nav-link">Service</a>
                            {/* <a href="portfolio.html" className="nav-item nav-link">Catalog</a> */}
